...
<c:if test='${order.location != location}'>
    <font color="lightgray">
         ...
         <c:out escapeXml="false" value="<img src=${flag} align=absmiddle> On <b>${order.creationDate}</b> an order for <b>${order.description}</b> was placed in <b>${order.location}</b>" /><br/>
